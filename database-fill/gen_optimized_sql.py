    ...
    for id in range(0, record_per_table, 1000):
        ...
        for sub_id in range(1000):
            if id+sub_id == record_per_table-1:
                query += f"('{data_list[id+sub_id][0]}', {id}, {id}, {data_list[id+sub_id][3]});\n"
            else:
                query += f"('{data_list[id+sub_id][0]}', {id}, {id}, {data_list[id+sub_id][3]}),\n"
        f.write(query)
...
with open('optimized-sql-scripts/incident_fill.sql', 'w+') as f:
    for id in range(0, record_per_table, 1000):
        ...
        for sub_id in range(1000):
            if id+sub_id == record_per_table-1:
                query += f"(DATE '{data_list[id+sub_id][0]}-{data_list[id+sub_id][1]}-{data_list[id+sub_id][2]}', \
                        {id}, {data_list[id+sub_id][4]}, '{data_list[id+sub_id][5]}', \
                        '{data_list[id+sub_id][6]}', {data_list[id+sub_id][7]}, {data_list[id+sub_id][8]-3*persons_offset});\n"
            else:
                query += f"(DATE '{data_list[id+sub_id][0]}-{data_list[id+sub_id][1]}-{data_list[id+sub_id][2]}', \
                        {id}, {data_list[id+sub_id][4]}, '{data_list[id+sub_id][5]}', \
                        '{data_list[id+sub_id][6]}', {data_list[id+sub_id][7]}, {data_list[id+sub_id][8]-3*persons_offset}),\n"
...
with open('optimized-sql-scripts/casualty_fill.sql', 'w+') as f:
    for id in range(0, record_per_table, 1000):
        ...
        for sub_id in range(1000):
            if id+sub_id == record_per_table-1:
                query += f"('{persons_list[id+sub_id][0]}', {persons_list[id+sub_id][1]}, {persons_list[id+sub_id][2]}, \
                        '{persons_list[id+sub_id][3]}', {data_list[id+sub_id][1]});\n"
            else:
                query += f"('{persons_list[id+sub_id][0]}', {persons_list[id+sub_id][1]}, {persons_list[id+sub_id][2]}, \
                        '{persons_list[id+sub_id][3]}', {data_list[id+sub_id][1]}),\n"
        f.write(query)
...
with open('optimized-sql-scripts/govn_fill.sql', 'w+') as f:
    for id in range(0, record_per_table, 1000):
        ...
        for sub_id in range(1000):
            if id+sub_id == record_per_table-1:
                query += f"('{persons_list[persons_offset+id+sub_id][0]}', {persons_list[persons_offset+id+sub_id][1]}, \
                        {persons_list[persons_offset+id+sub_id][2]}, '{persons_list[persons_offset+id+sub_id][3]}', {id});\n"
            else:
                query += f"('{persons_list[persons_offset+id+sub_id][0]}', {persons_list[persons_offset+id+sub_id][1]}, \
                        {persons_list[persons_offset+id+sub_id][2]}, '{persons_list[persons_offset+id+sub_id][3]}', {id}),\n"
        f.write(query)
...
with open('optimized-sql-scripts/citizen_fill.sql', 'w+') as f:
    for id in range(0, record_per_table, 1000):
        ...
        for sub_id in range(1000):
            if id+sub_id == record_per_table-1:
                query += f"('{persons_list[2*persons_offset+id+sub_id][0]}', {persons_list[2*persons_offset+id+sub_id][1]}, \
                        {persons_list[2*persons_offset+id+sub_id][2]}, '{persons_list[2*persons_offset+id+sub_id][3]}', {id}, {data_list[id][3]});\n"
            else:
                query += f"('{persons_list[2*persons_offset+id+sub_id][0]}', {persons_list[2*persons_offset+id+sub_id][1]}, \
                        {persons_list[2*persons_offset+id+sub_id][2]}, '{persons_list[2*persons_offset+id+sub_id][3]}', {id}, {data_list[id][3]}),\n"
        f.write(query)
...
with open('optimized-sql-scripts/criminal_fill.sql', 'w+') as f:
    for id in range(0, record_per_table, 1000):
        ...
        for sub_id in range(1000):
            if id+sub_id == record_per_table-1:
                query += f"('{persons_list[3*persons_offset+id+sub_id][0]}', {persons_list[3*persons_offset+id+sub_id][1]}, \
                        {persons_list[3*persons_offset+id+sub_id][2]}, '{persons_list[3*persons_offset+id+sub_id][3]}', {data_list[id+sub_id][1]});\n"
            else:
                query += f"('{persons_list[3*persons_offset+id+sub_id][0]}', {persons_list[3*persons_offset+id+sub_id][1]}, \
                        {persons_list[3*persons_offset+id+sub_id][2]}, '{persons_list[3*persons_offset+id+sub_id][3]}', {data_list[id+sub_id][1]}),\n"
        f.write(query)
